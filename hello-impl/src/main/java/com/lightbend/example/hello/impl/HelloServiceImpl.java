package com.lightbend.example.hello.impl;
...
import com.lightbend.example.hello.api.GreetingMessage;
import com.lightbend.example.hello.api.HelloService;
import com.lightbend.example.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.lightbend.example.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.lightbend.example.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.lightbend.example.hello.api.HelloEvent.GreetingMessageChanged(
