...
import com.lightbend.example.hello.impl.HelloCommand.Hello;
import com.lightbend.example.hello.impl.HelloCommand.UseGreetingMessage;
import com.lightbend.example.hello.impl.HelloEvent.GreetingMessageChanged;
